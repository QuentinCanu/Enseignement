...
\item Si $f$ admet une unique racine $r$, alors $f$ est du même signe que $a$ sur $\R$, et vaut $0$ en $r$.
...
\end{remark}
\begin{exercize*}
Soit $f \colon x \mapsto x^2 - 5x + 3$. Compléter le tableau de signes de $f$.
\begin{center}
\begin{tikzpicture}
\tkzTabInit{$x$/1, Signe de $f$/2}{$-\infty$, , $+\infty$};
\end{tikzpicture}
\end{center}
\end{exercize*}
