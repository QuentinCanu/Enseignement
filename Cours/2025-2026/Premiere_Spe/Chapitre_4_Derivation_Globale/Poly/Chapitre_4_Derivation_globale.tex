...
\end{remark}
\begin{exercize*}
Soit $f$ une fonction définie sur $[-6;6]$ dont la courbe représentative $\mathcal{C}_f$ est représentée sur le repère suivant (à gauche) :
\begin{center}
\hfill
\begin{tikzpicture}
...
\item On a représenté sur le repère à droite la restriction de $f$ sur l'intervalle $[-6;-1]$. En déduire en quel abscisse $f$ admet un extremum local.  
\end{alphaquestions}
\end{exercize*}
\begin{proposition}
