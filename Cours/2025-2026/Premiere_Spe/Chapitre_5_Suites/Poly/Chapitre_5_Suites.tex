...
\begin{itemize}
\item $u_n = 3n + 1$ pour tout $n \in \N$ : 
\item $u_n = 5 \times 2^n$ pour tout $n \in \N$ : 
\item $u_n = \text{\og Le nombre de lettres dans l'écriture en français de $n$ \fg}$, pour tout $n \in \N$ : 
\end{itemize}
\end{example}
\begin{definition}
...
\begin{itemize}
\item $v_0 = 6$ et $v_{n+1} = v_n + 4$ : 
\item $v_0 = 2$ et $v_{n+1} = 5 \times v_n$ :  
\end{itemize}
\end{example}
\newpage
...
\item On dit que $(u_n)_{n \in \N}$ est \textbf{strictement croissante} si et seulement si pour tout $n \in \N$, on a $u_n < u_{n+1}$.
\item On dit que $(u_n)_{n \in \N}$ est \textbf{décroissante} si et seulement si pour tout $n \in \N$, on a $u_{n+1} \leq u_n$. 
\item On dit que $(u_n)_{n \in \N}$ est \textbf{strictement décroissante} si et seulement si pour tout $n \in \N$, on a $u_{n+1} < u_n$. 
\end{itemize}
\end{definition}
\begin{proposition}
Soit $(u_n)_{n \in \N}$ une suite numérique.
...
\item La suite $(u_n)_{n \in \N}$ est strictement croissante si et seulement si, pour tout $n \in \N$, $u_{n+1} - u_n > 0$. 
\item La suite $(u_n)_{n \in \N}$ est décroissante si et seulement si, pour tout $n \in \N$, $u_{n+1} - u_n \leq 0$. 
\item La suite $(u_n)_{n \in \N}$ est décroissante si et seulement si, pour tout $n \in \N$, $u_{n+1} - u_n < 0$. 
\end{itemize}
\end{proposition}
\begin{proposition}
Soit $(u_n)_{n \in \N}$ une suite numérique. On suppose que pour tout $n \in \N$, $u_n > 0$.
\begin{itemize}
\item La suite $(u_n)_{n \in \N}$ est croissante si et seulement si, pour tout $n \in \N$, $\dfrac{u_{n+1}}{u_n} \geq 1$. 
\item La suite $(u_n)_{n \in \N}$ est strictement croissante si et seulement si, pour tout $n \in \N$, $\dfrac{u_{n+1}}{u_n} > 1$. 
\item La suite $(u_n)_{n \in \N}$ est décroissante si et seulement si, pour tout $n \in \N$, $\dfrac{u_{n+1}}{u_n} \leq 1$. 
\item La suite $(u_n)_{n \in \N}$ est décroissante si et seulement si, pour tout $n \in \N$, $\dfrac{u_{n+1}}{u_n} < 1$. 
\end{itemize}
\end{proposition}
\begin{example}
...
\begin{definition}
Soit $(u_n)_{n \in \N}$ une suite numérique. On dit que la suite est \textbf{arithmétique} si et seulement il existe $r \in \R$ tel que pour tout $n \in \N$
\begin{equation*}
u_{n+1} = u_n + r
\end{equation*}
...
\node (5) at (10,0) {$\dots$};
\draw[->] (0) -- node[midway,above] {$+r$} (1);
\draw[->] (1) -- node[midway,above] {$+r$} (2);
\draw[->] (2) -- node[midway,above] {$+r$} (3);
\draw[->] (3) -- node[midway,above] {$+r$} (4);
\draw[->] (4) -- node[midway,above] {$+r$} (5);
\end{tikzpicture}
\end{center}
\end{remark}
\begin{example}
...
\begin{alphaquestions}
\item $(u_n)_{n \in \N}$ est la suite arithmétique de premier terme $0$ et de raison $1$ : 
\item $(u_n)_{n \in \N}$ est la suite arithmétique de premier terme $1$ et de raison $2$ : 
\item $(u_n)_{n \in \N}$ est la suite arithmétique de premier terme $10$ et de raison $-\dfrac{1}{2}$ : 
\end{alphaquestions}
\end{example}
...
\begin{alphaquestions}
\item $(u_n)_{n \in \N}$ est la suite arithmétique de premier terme $6$ et de raison $5$ : 
\item $(u_n)_{n \in \N}$ est la suite arithmétique de premier terme $0$ et de raison $-2$ : 
\item $(u_n)_{n \in \N}$ est la suite arithmétique de premier terme $1$ et de raison $\dfrac{1}{5}$ : 
\end{alphaquestions}
\end{example}
\begin{proposition}
...
\node[draw,circle] (4) at (8,0) {$u_4$};
\node (5) at (10,0) {$\dots$};
\draw[->] (0) -- node[midway,above] {$\times q$} (1); 
\draw[->] (1) -- node[midway,above] {$\times q$} (2); 
\draw[->] (2) -- node[midway,above] {$\times q$} (3); 
\draw[->] (3) -- node[midway,above] {$\times q$} (4); 
\draw[->] (4) -- node[midway,above] {$\times q$} (5);
\end{tikzpicture}
\end{center}
\end{remark}
\begin{example}
Calculer les termes $u_1$, $u_2$ et $u_3$ pour chaque définition suivante :
\begin{alphaquestions}
\item $(u_n)_{n \in \N}$ est la suite géométrique de premier terme $1$ et de raison $2$ : 
\item $(u_n)_{n \in \N}$ est la suite géométrique de premier terme $64$ et de raison $\dfrac{1}{2}$ : 
\item $(u_n)_{n \in \N}$ est la suite géométrique de premier terme $1000$ et de raison $-0,1$ : 
\end{alphaquestions}
\end{example}
...
\draw (0,1) node {$\times$};
\draw (1,1.3) node {$\times$};
\draw (2,{1.3^2}) node {$\times$};
\draw (3,{1.3^3}) node {$\times$};
\draw (4,{1.3^4}) node {$\times$};
\draw (5,{1.3^5}) node {$\times$};
\draw (6,{1.3^6}) node {$\times$};
\draw[dashed] plot[domain=0:6.3] (\x,{1.3^(\x)});
\end{tikzpicture}
\end{center}        
\end{definition}
\newpage
...
\scalebox{0.75}{
\begin{tikzpicture}
\draw[help lines] (-0.25,-3.25) grid[step=0.5] (10.25,3.25);
\draw[axis] (-0.25,0) -- (10.25,0) node[right] {$n$}; 
\draw[axis] (0,-3.25) -- (0,3.25) node[above] {$u_n$}; 
...
\begin{definition}
Soit $(u_n)_{n \in \N}$ une suite numérique. On dit que \textbf{la suite $(u_n)$ admet $+\infty$ comme limite} quand les valeurs de $u_n$ sont aussi grandes que l'on veut à la mesure où $n$ augmente. On le note
\begin{equation*}
\lim_{n \to +\infty} u_n = +\infty 
\end{equation*}
\end{definition}    
\begin{definition}
Soit $(u_n)_{n \in \N}$ une suite numérique. On dit que \textbf{la suite $(u_n)$ admet $-\infty$ comme limite} quand les valeurs de $u_n$ sont aussi petites que l'on veut à la mesure où $n$ augmente. On le note
\begin{equation*}
\lim_{n \to +\infty} u_n = -\infty 
\end{equation*}
\end{definition}    
