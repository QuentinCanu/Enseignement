...
\subsection{Trapèze}
\begin{proposition}
Soit $ABCD$ un quadrilatère. Alors, si $\vect{AB}$ et $\vect{DC}$ sont colinéaires, alors $ABCD$ est un trapèze.
\end{proposition}
...
\begin{proposition}
Soient trois points $A$, $B$ et $C$ du plan. Alors, $A$, $B$ et $C$ sont alignés si et seulement si $\vect{AB} = \vect{AC}$.
\end{proposition}
